...
public class CO2_Animation_absolute {

	private static final String SCENE_TITLE = "CO2 PPM shares (absolute)";
	private static final String CARBON_EMISSIONS_DATASET = RelativePaths.CARBON_EMISSIONS_SHARES_1960_2014_XML;
	...
	private static final String outputFile = "test/animation/absolute/AnimatedSymbols_CO2ppm.x3d";
...
//		return new double[] { minValue, quarterValue, halfValue, thirtyFiveValue, maxValue };
		return new double[] { 0, 30, 60, 100, maxValue };
...
//		double[] extents = new double[] { 0.2, 5, 10 };
	...
	public static void main(String args[]) {
		...
		CO2_Animation_absolute app = new CO2_Animation_absolute();
